...
define([
    ...
    // Extension for mage.lofReviewGallery - Add advanced settings block
    $.widget('mage.lofReviewGallery', $.mage.lofReviewGallery, {
        options: {
