...
define([
     ...
     */
    $.widget('mage.hgatiReviewGallery', {
        options: {
        ...
        _bind: function () {
            this._on({
                ...
                'mouseup [data-role=delete-button]': function (event) {
                    ...
                    this.element.find('.removed').remove();
                },
    ...
    // Extension for mage.hgatiReviewGallery - Add advanced settings block
    $.widget('mage.hgatiReviewGallery', $.mage.hgatiReviewGallery, {
        options: {
    ...
    return $.mage.hgatiReviewGallery;
});
