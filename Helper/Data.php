...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->scopeConfig->getValue(self::XML_PATH_REPLY_EMAIL_TEMPLATE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
    }
    ...
    public function getAutoSendReminder() {
        return $this->scopeConfig->isSetFlag(self::XML_SEND_REMINDER_AUTO, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
    ...
    public function getSenderValue($config)
    {
        ...
        elseif($config == 'custom2'){
            $value = [
                'name' => $this->scopeConfig->getValue('trans_email/ident_custom2/name', \Magento\Store\Model\ScopeInterface::SCOPE_STORE),
                'email' => $this->scopeConfig->getValue('trans_email/ident_custom2/email', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)
            ];
        }else{
            $value = [
