...
use Hgati\ProductReviews\Api\LikeRepositoryInterface;
...
/**
 * Class LikeRepository like a review
 */
class LikeRepository implements LikeRepositoryInterface
{
    ...
    public function execute(int $customerId, int $reviewId): ReviewInterface
    {
        ...
        if (!$this->checkExistReport($customerId, $reviewId)) {
            ...
            $helpful = (int)$customize->getCountHelpful() + 1;

            $customize->setCountHelpful($helpful);
            ...
            throw new CouldNotSaveException(__(
                'You marked like the review id %1 before', $reviewId
            ));
        }
        return $review;
    }
    ...
    public function checkExistReport(int $customerId, int $reviewId): bool
    {
        $collection = $this->reportCollectionFactory->create()
                        ...
                        ->addFieldToFilter("rate_type", "helpful");
